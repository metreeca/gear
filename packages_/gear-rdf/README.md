...
[![npm](https://img.shields.io/npm/v/@metreeca/gear-rdf)](https://www.npmjs.com/package/@metreeca/gear-rdf)

RDF processing tasks for [@metreeca/gear](https://github.com/metreeca/gear).

# Installation

```shell
npm install @metreeca/gear      # the job execution API
npm install @metreeca/gear-rdf  # this package
```
