...
[![npm](https://img.shields.io/npm/v/@metreeca/gear-ical)](https://www.npmjs.com/package/@metreeca/gear-ical)

iCalendar processing tasks for [@metreeca/gear](https://github.com/metreeca/gear).

# Installation

```shell
npm install @metreeca/gear       # the job execution API
npm install @metreeca/gear-ical  # this package
```
