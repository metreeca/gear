...
public final class HTML implements Format<Document> {
     ...
     *         the {@code message} {@linkplain Message#charset() charset} or an empty optional if the
     *         {@code "Content-Type"} {@code message} header is not empty and is not matched by {@link #MIME}
     */
