...
[![npm](https://img.shields.io/npm/v/@metreeca/flow-ical)](https://www.npmjs.com/package/@metreeca/flow-ical)

iCalendar processing tasks for [@metreeca/flow](https://github.com/metreeca/flow).

# Installation

```shell
npm install @metreeca/flow       # the job execution API
npm install @metreeca/flow-ical  # this package
```
