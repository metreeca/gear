...
[![npm](https://img.shields.io/npm/v/@metreeca/flow-json)](https://www.npmjs.com/package/@metreeca/flow-json)

JSON processing tasks for [@metreeca/flow](https://github.com/metreeca/flow).

# Installation

```shell
npm install @metreeca/flow       # the job execution API
npm install @metreeca/flow-json  # this package
```
