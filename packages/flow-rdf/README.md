...
[![npm](https://img.shields.io/npm/v/@metreeca/flow-rdf)](https://www.npmjs.com/package/@metreeca/flow-rdf)

RDF processing tasks for [@metreeca/flow](https://github.com/metreeca/flow).

# Installation

```shell
npm install @metreeca/flow      # the job execution API
npm install @metreeca/flow-rdf  # this package
```
