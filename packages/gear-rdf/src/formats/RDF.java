...
import static com.metreeca.flow.http.Message.mimes;
import static com.metreeca.flow.http.Response.BAD_REQUEST;
...
public final class RDF implements Format<Model> {
    ...
    private static Model rdf(final RDFParser parser, final Consumer<RDFParser> processor) throws FormatException {
        ...
        if ( fatals.isEmpty() ) {
            ...
            throw new FormatException(BAD_REQUEST, Stream
    ...
    @Override public Optional<Model> decode(final Message<?> message) {
        return Optional.of(message.type(MIME))
                ...
                .flatMap(type -> service(RDFParserRegistry.getInstance(), set(type)))
